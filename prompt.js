...
# ⛔ 자주 나오는 실수 — 출력 전 반드시 확인
- titles는 **정확히 3개**, descriptions도 **정확히 3개**입니다. 4개 이상 만들지 마세요.
- 각 항목의 ko 필드는 **한국어 번역문**입니다. ja 값을 그대로 복사해 넣는 실수가 잦습니다.
  ja와 ko가 같은 문자열이면 틀린 것입니다. ko에는 반드시 한글이 들어가야 합니다.
- ko를 빈 문자열로 두지 마세요.
